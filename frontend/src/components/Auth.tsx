...
import { signupType } from "@nimeshthakur/medium-common";
    ...
    return <div className="h-screen flex justify-center flex-col">
        <div className="flex justify-center">
            <div>
                ...
                <div className="pt-4">
                    {type === "signup" ?  <LabelledInput label="Name" placeholder="Nimesh Thakur..." onChange={(e) => {
                        setPostInputs({
                            ...postInputs, //existing email and password
                            name: e.target.value
                        })
                    }} /> : null}
                    <LabelledInput label="Email" placeholder="nimeshthakur0@gmail.com" onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
